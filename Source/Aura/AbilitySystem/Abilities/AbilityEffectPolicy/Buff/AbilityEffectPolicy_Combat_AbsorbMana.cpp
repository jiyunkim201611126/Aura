...
void UAbilityEffectPolicy_Combat_AbsorbMana::ApplyEffect(UGameplayAbility* OwningAbility, AActor* TargetActor, const FEffectPolicyContext& EffectPolicyContext)
{
	if (EffectClass)
	{
