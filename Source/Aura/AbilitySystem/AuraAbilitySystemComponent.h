...
DECLARE_MULTICAST_DELEGATE_FourParams(FAbilityEquipped, const FGameplayTag& /*AbilityTag*/, const FGameplayTag& /*InputTag*/, const FGameplayTag& /*StatusTag*/, const FGameplayTag& /*PreviousInputTag*/)
